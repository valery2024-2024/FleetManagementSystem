...
Система управління доставкою вантажів, розроблена з використанням принципів ООП, SOLID та патернів проєктування.
...
Проєкт складається з модулів:

- **Entities** — доменні моделі
- **Services** — бізнес-логіка
- **Repositories** — робота з даними
- **Factories** — створення об’єктів
- **Utils** — допоміжні класи
- **Tests** — модульні тести

## Використані патерни

- Strategy — розрахунок вартості доставки
- Factory — створення транспортних засобів
- Repository — робота з даними
- Observer — система подій
- Decorator — додавання функціоналу
- Facade — спрощення роботи з системою
- Composite — групування вантажів
...
```bash
dotnet build
dotnet run --project FleetManagementSystem.App
```
